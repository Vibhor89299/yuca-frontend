      ...
      <div className="relative z-10">
        <div className="container mx-auto px-4 lg:px-8 max-w-7xl">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <div className="flex items-center justify-center space-x-2 text-sm text-kimber uppercase tracking-widest">
              <span>Cart</span>
                ...
                <section className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <Label htmlFor="guestName" className="text-xs uppercase tracking-widest text-kimber">Full Name</Label>
                      <Input
                        id="guestName"
                  ...
                  <RadioGroup value={form.paymentMethod} onValueChange={handlePaymentMethod}>
                    <div className="flex items-start space-x-3 bg-white/60 p-4 rounded-lg border border-oak/20">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-xs text-kimber">Credit/Debit Cards, UPI, Net Banking, Wallets</p>
                      </div>
                    </div>
                  </RadioGroup>

                  {form.paymentMethod === "razorpay" && (
                    <div className="mt-4 flex items-center justify-center space-x-2 text-xs text-kimber bg-oak/5 py-2 rounded">
                  ...
                  {items.map((item) => (
                    <div key={item.id} className="flex gap-4 py-2">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-kimber">Qty: {item.quantity}</p>
                      </div>
