        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div
            className={`lg:col-span-1 lg:sticky lg:top-8 lg:h-fit ${
              sidebarOpen
                ? "fixed top-0 left-0 h-full w-80 z-50 lg:relative lg:w-auto lg:h-fit"
                : "hidden lg:block"
            }`}
          >
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-4">
                          {orders.slice(0, 3).map((order) => (
                            ...
                            >
                              ...
                              <div className="flex md:flex-col justify-between text-left md:text-right">
                                <Badge
                  ...
                  <div className="bg-[#fbfaf8] rounded-lg shadow-sm border border-sage-200">
                    ...
                    <div className="p-6">
                      <div className="grid grif-cols-1 md:grid-cols-2 gap-4">
                        <Button
                          variant="outline"
                          onClick={() => setActiveTab("orders")}
              ...
              <div className="bg-[#fbfaf8] rounded-lg shadow-sm border border-sage-200">
                <div className="p-6 border-b border-sage-200">
                  ...
                  <p className="text-sm text-stone-600 mt-1">
                    Wishlist API not available - showing sample items
                  </p>
                </div>
                <div className="p-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {wishlistItems.map((item, index) => (
                      <div
                        key={index}
                        className="border border-sage-200 rounded-lg p-4"
                      >
                        <img
                        ...
                        <div className="flex gap-2">
                          <Button
                            size="sm"
                            className="flex-1 bg-amber-700 text-[#fbfaf8] hover:bg-amber-800"
                          >
                            Add to Cart
                          </Button>
                          <Button
