...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen page-enter pt-[100px] pb-12 relative">
      <div
            ...
            >
              <div className="space-y-8">
                ...
                <div className="bg-white/40 backdrop-blur-md rounded-xl p-6 border border-oak/10 text-center shadow-sm">
                  ...
                  <p className="text-xs uppercase tracking-widest text-kimber">Member</p>
                </div>
                    ...
                    return (
                      <button
                        ...
                        className={`w-full flex items-center gap-4 px-6 py-4 rounded-lg text-left transition-all duration-300 group ${isActive
                          ...
                          : "text-kimber hover:bg-white/40 hover:text-oak"
                          }`}
                      >
                        <Icon className={`w-4 h-4 ${isActive ? "text-autumnFern" : "text-kimber/70 group-hover:text-autumnFern transition-colors"}`} />
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white/40 rounded-lg p-4 text-center border border-oak/5">
                    ...
                    <p className="text-[10px] uppercase tracking-widest text-kimber">Orders</p>
                  </div>
                  <div className="bg-white/40 rounded-lg p-4 text-center border border-oak/5">
                    ...
                    <p className="text-[10px] uppercase tracking-widest text-kimber">Spent</p>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-white/40 backdrop-blur-md border border-oak/10 p-6 rounded-xl hover:shadow-md transition-all duration-300 group">
                      <div className="flex justify-between items-start mb-4">
                        <div>
                          <p className="text-xs uppercase tracking-widest text-kimber mb-1">Total Orders</p>
                      ...
                      <div className="text-sm text-kimber">
                    ...
                    <div className="bg-white/40 backdrop-blur-md border border-oak/10 p-6 rounded-xl hover:shadow-md transition-all duration-300 group">
                      <div className="flex justify-between items-start mb-4">
                        <div>
                          <p className="text-xs uppercase tracking-widest text-kimber mb-1">Total Investment</p>
                  ...
                  <div className="bg-white/60 backdrop-blur-md border border-oak/10 rounded-xl overflow-hidden">
                    ...
                    <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
                      <div className="space-y-1">
                        <p className="text-xs uppercase tracking-widest text-kimber">Email</p>
                        <p className="text-oak font-medium">{userData?.email || "Not provided"}</p>
                      </div>
                      <div className="space-y-1">
                        <p className="text-xs uppercase tracking-widest text-kimber">Phone</p>
                  ...
                  <div className="bg-white/60 backdrop-blur-md border border-oak/10 rounded-xl overflow-hidden">
                    ...
                    <div className="divide-y divide-oak/5">
                      {ordersLoading ? (
                          ...
                          <div key={order.id} onClick={() => navigate(`/order/${order.id}`)} className="p-4 hover:bg-white/60 transition-colors cursor-pointer flex items-center justify-between group">
                            <div className="flex items-center gap-4">
                              ...
                              <div>
                                ...
                                <p className="text-xs text-kimber">{formatDate(order.createdAt)}</p>
                              </div>
                            </div>
                            <div className="flex items-center gap-4">
                        ...
                        <div className="p-8 text-center text-kimber text-sm">No recent orders found.</div>
                      )}
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-6 animate-fade-in">
                  ...
                  {ordersLoading ? (
                        ...
                        <div key={order.id} className="bg-white/40 backdrop-blur-md border border-oak/10 rounded-xl overflow-hidden hover:shadow-md transition-shadow duration-300">
                          <div className="p-6 flex flex-col md:flex-row gap-6 justify-between items-start md:items-center border-b border-oak/5">
                            <div>
                              ...
                              <p className="text-sm text-kimber">Placed on {formatDate(order.createdAt)}</p>
                            </div>
                            <div className="text-right">
                              <p className="text-sm text-kimber uppercase tracking-widest mb-1">Total Amount</p>
                          ...
                          <div className="p-4 bg-white/40 flex justify-between items-center">
                            <div className="flex items-center gap-2 text-sm text-kimber">
                    ...
                    <div className="bg-white/60 backdrop-blur-md rounded-xl p-12 text-center border border-oak/10">
                      ...
                      <p className="text-kimber mb-6 font-light">Start your sustainable journey with YUCA collection.</p>
